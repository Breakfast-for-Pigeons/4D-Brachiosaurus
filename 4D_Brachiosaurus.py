...
def get_bellow():
    '''
    The get_bellow function will randomly select one of the
    Brachiosaurus bellow sound files and then return it and its file
    length to the main function.
    '''
...
def activate_brachiosaurus(sound, sound_length):
    '''
    The activate_brachiosaurus function has two parameters: sound and
    sound length.
    ...
    will be one of the randomly selected bellows and its length. This
